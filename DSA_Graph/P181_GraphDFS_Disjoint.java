...
public class P181_GraphDFS_Disjoint {
     ...
     */
    static ArrayList<Integer> dfsDisjoint(ArrayList<ArrayList<Integer>> adjList)
    {
        ArrayList<Integer> dfsResult = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The DFS traversal is: "+dfsDisjoint(adjList));
    }
}
