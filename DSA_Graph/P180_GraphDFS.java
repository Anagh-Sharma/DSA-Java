...
public class P180_GraphDFS {
     ...
     */
    static ArrayList<Integer> dfsTraversal(ArrayList<ArrayList<Integer>> adjList, int source) 
    {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The DFS traversal is: "+dfsTraversal(adjList, source));
    }
