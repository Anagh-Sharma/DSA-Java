...
public class P134_NextGreaterElement {
    static int[] nextGreater(int arr[], int n, int s[]) 
    {
        /*
        ...
        for(int i = n-1; i >= 0; i--) 
        {
             ...
             * is smaller than or equal to the current element.
             */
    ...
    public static void main(String[] args) {
        ...
        int s[] = new int[n];
        System.out.println();
        int res[] = nextGreater(arr, n, s);
        System.out.println("The given array is: ");
        for(int i : arr) {
            System.out.print(i + ", ");
        }
        System.out.println();
        System.out.println("The next greater elements at each index are: ");
        for(int i : res) {
            System.out.print(i + ", ");
        }
    }
